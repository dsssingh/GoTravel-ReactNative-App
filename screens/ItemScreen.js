...
const ItemScreen = ({ route }) => {
  ...
  console.log(data);
  return (
    <SafeAreaView className="flex-1 bg-white relative mt-[50px]">
      <ScrollView className="flex-1 px-4 py6-">
      ...
      {/* Image Container */}
        ...
        <View className="relative bg-white shadow-lg">
          ...
          />
          <View className="flex-row inset-x-0 top-5 justify-between px-6 absolute">
          ...
          <View className="flex-row inset-x-0 bottom-5 justify-between px-6 absolute">
